...
int main(){
    ...
    if(grade >= 90){
        if (grade >= 93){
            ...
            printf("Your garde is %d percent. That is an A-.\n", grade);
        }
    }else if (grade >= 80){
        printf("Your grade is %d pertcent. That is an B.\n", grade);
    }else if (grade >= 70){
        printf("Your grade is %d pertcent. That is an C.\n", grade);
    }else if (grade >= 60){
        printf("Your grade is %d pertcent. That is an D.\n", grade);
    }else{
        printf("Your grade is %d pertcent. That is an F.\n", grade);
    }
